...
public class US6tests {
    ...
    @Test
    void deletePromptTest() throws IOException, InterruptedException {
        ...
        in.close();
        assertEquals("Deleted at index: " + "0" + "\nCommand: " + "New Question" + "\nQuestion: " + "this is a question" + "\nAnswer: " + "This is the mock answer!!! :)", response);
